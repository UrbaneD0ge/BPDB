...
>
    ...
    >
        ...
        <path
            ...
            style="baseline-shift:baseline;display:inline;overflow:visible;fill:none;fill-opacity:1;fill-rule:nonzero;stroke-width:1.32291667;stroke-dasharray:none;stroke-opacity:1;enable-background:accumulate;stop-color:#a38226;stop-opacity:1"
            stroke="{strokeHex}"
