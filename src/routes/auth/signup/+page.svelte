...
<main class="h-svh pt-12 m-2">
    ...
    <label for="password">Password: <span id="pwNote">[At least 7 characters. Contains 1: uppercase & lowercase letter, number, and special character]</span><span class="error-message italic">{form?.fieldErrors?.fieldErrors?.password}</span></label>
